...
import com.summersky.gulishop.product.dao.AttrAttrgroupRelationDao;
import com.summersky.gulishop.product.dao.AttrGroupDao;
...
import com.summersky.gulishop.product.dao.AttrDao;
import com.summersky.gulishop.product.entity.AttrEntity;
import com.summersky.gulishop.product.service.AttrService;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public void saveAttr(AttrVo attr) {
        ...
        // 拷贝,参数1：要拷贝的对象，参数2：接收拷贝的对象，这种拷贝需要VO和实体类的属性名一一对应
